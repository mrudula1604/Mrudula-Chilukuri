...
INSERT INTO `discount_details` VALUES ('CVB','wertyq','26%'),('EB','Early Bird','10%'),('EMP','EMPLOYEE','23%'),('GROUP','Group booking','10%'),('HOL','Holiday Season','20%'),('MEMB','Membership','25%'),('SENCIT','Senior Citizens','20%'),('STUD','Students','5%'),('WEEKEND','Weekend Booking','10%');
